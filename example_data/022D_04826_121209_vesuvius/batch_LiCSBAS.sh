...
p05_clip_range_geo="14.30/14.52/40.75/40.90"	# e.g. 130.11/131.12/34.34/34.6 (in deg)

### Frequently used options. If blank, use default. ###
p01_start_date="20140101"	# default: 20141001
p01_end_date="20220216"		# default: today
p01_get_gacos="n" 		# y/n 
...
p15_n_ifg_noloop_thre="80"	# default: 50
...
p01_frame="022D_04826_121209"      #e.g. 021D_04972_131213 
