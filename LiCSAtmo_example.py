...
licsalert_dir = str(Path("/home/matthew/university_work/my_software_releases/LiCSAlert-4.1.0").resolve())

if licsalert_dir not in sys.path:
    print("Adding LiCSAlert to your path...", end = '')
...
#%% Example 01: sICA at Campi Flegrei
